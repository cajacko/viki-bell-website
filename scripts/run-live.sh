...
docker run -d --name viki-bell-website-mysql -v viki-bell-website:/var/lib/mysql --env-file .env mysql:5.7
...
docker run -e VIRTUAL_HOST=vikibell.com,www.vikibell.com --link viki-bell-website-mysql:viki-bell-website-mysql --expose 80 -d --env-file .env --name viki-bell-website-web viki-bell-website-web
