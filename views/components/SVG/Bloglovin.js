...
const Bloglovin = ({ size, colour }) => {
  const originalWidth = 2432;
  const originalHeight = 278;

  const width = Math.round((originalWidth / originalHeight) * size);
  ...
  return (
    <svg
      ...
      height={size}
      width={width}
      viewBox="0 0 243.2 27.8"
    >
      <g>
        <path
          d="M17.3,13.5c2.5-0.5,4.6-2.8,4.6-6.2c0-3.6-2.6-6.9-7.7-6.9H0v26.9h14.6c5.2,0,7.8-3.2,7.8-7.3
