...
class Image extends React.Component {
  ...
  positionImage() {
    ...
    const imageHeight = this.props.image.originalHeight;
    const imageWidth = this.props.image.originalWidth;
  ...
  render() {
    const width = this.props.image.originalWidth;
    const height = this.props.image.originalHeight;
      ...
      wrapper = (
        <div style={wrapperStyle}>
          <img
            ...
            height={this.props.image.originalHeight}
            width={this.props.image.originalWidth}
            style={style.image}
